package com.example.owo.utils.util_http;


import com.example.owo.model.YouTuTag;
        ...
        if (jsonArrayList == null) {
            ...
            for (int i = 0; i < jsonArrayList.size(); i++) {
                ...
                hm.put("latitude", jsonArrayList.get(i)
                        .getString("latitude"));
                hm.put("login_edittext_drawable_left_password", jsonArrayList.get(i)
                        .getString("login_edittext_drawable_left_password"));
...
//                    .getString("girlavatar"));
    ...
    public static HashMap<String, Object> AnalysisUserInfoPose(
        ...
        if (getCode(jsonStr) == 100) {
            ...
            hm.put("login_edittext_drawable_left_password", obj
                    .getString("passWord"));
            return hm;
        } else {
            return null;
    ...
    public static BeanTask getBeanTaskFromJsonObject(JSONObject jsonObject) {
        ...
        try {
            ...
            beanTask.setTaskDeadLine((String) jsonObject.get("taskDeadline"));
            beanTask.setTaskPublishTime((String) jsonObject.get("taskPublishTime"));
    ...
    public static List<BeanTag> AJResultGetInterestTagBySex(String jsonData) throws JSONException {
        ...
        if (getCode(jsonData) == 200) {
            ...
            for (int i = 0; i < dataArray.length(); i++) {
                ...
                beanTag.setType((Integer) jsonObject1.get("tag_type"));
    ...
    public static List<BeanRecyclerViewItem> AJResultGetUserByDis(String jsonData) throws JSONException {
        ...
        if (getCode(jsonData) == 200) {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                item.setDis((Double) jsonObject1.get("distance"));
                item.setUrlAvatar((String) jsonObject1.get("avatar"));
                item.setUserId((Integer) jsonObject1.get("userId"));
                item.setSex((Integer) jsonObject1.get("sex"));
                result.add(item);
            }
        }
        return result;
    ...
    public static List<BeanViewPagerItem> AJResultGetUserByMatchIndex(String jsonStr) throws JSONException {
        ...
        if (code != 0) {
            ...
            if (code == 200) {
                ...
                if (objStr != null) {
                    JSONObject obj = new JSONObject(objStr);
                    BeanViewPagerItem item = new BeanViewPagerItem();
                    HashMap<String, Object> hm = new HashMap<>();
                    int age = (obj.get("age") == null ? -1 : obj.getInt("age"));
                    String avatar = (obj.get("avator") == null ? "" : obj.getString("avator"));
                    String backimage = (obj.get("backimage") == null ? "" : obj.getString("backimage"));
                    ...
                    String longtitude = (obj.get("longtitude") == null ? "" : obj.getString("longtitude"));
                    String latitude = (obj.get("latitude") == null ? "" : obj.getString("latitude"));
                    String password = (obj.get("login_edittext_drawable_left_password") == null ? "" : obj.getString("login_edittext_drawable_left_password"));
                    String phonenumber = (obj.get("phonenumber") == null ? "" : obj.getString("phonenumber"));
                    String qq = (obj.get("qq") == null ? "" : obj.getString("qq"));
                    String wexid = (obj.get("wexid") == null ? "" : obj.getString("wexid"));
                    String sex = (obj.get("sex") == null ? "" : obj.getString("sex"));
                    ...
                    hm.put("longtitude", longtitude);
                    hm.put("latitude", latitude);
                    hm.put("login_edittext_drawable_left_password", password);
                    hm.put("wexid", wexid);
                    hm.put("sex", sex);
                    hm.put("stepstoday", stepstoday);
                    hm.put("regdate", obj.getString("regdate"));
                    ...
                    BeanUser beanUser = Constants.getBeanUserFromMap(hm);
                    int matchIndex = obj.getInt("matchIndex");
                    item.setBeanUser(beanUser);
                    item.setMatchDegree(matchIndex);
                    result.add(item);
                } else return null;
            } else return null;
        } else {
