...
import com.example.owo.model.ActivityRecord;
import com.example.owo.model.LoveShip;
import com.example.owo.model.PosLib;
import com.example.owo.model.User;
import com.example.owo.model.UserPose;
...
//        loveShip.setNameA(lsHM.get("boyname").toString());
    ...
    public static void setUserInfo(HashMap<String, Object> userHM) {
        ...
        user.setPassWord(userHM.get("login_edittext_drawable_left_password").toString());
